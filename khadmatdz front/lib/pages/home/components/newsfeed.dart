      ...
      body: Center(
        child: Container(
          ...
          child: ListView.builder(
            itemCount: _feedItems.length + 2, // +2 for HomeHeader and Categories
            itemBuilder: (BuildContext context, int index) {
              if (index == 0) {
                ...
                final itemIndex = index - 2; // Adjust index to account for header items
      ...
      child: Row(
        ...
        children: [
          TextButton.icon(
            ...
            label: Text(item.commentsCount == 0 ? '' : item.commentsCount.toString()),
          ),
          TextButton.icon(
            onPressed: () {},
            icon: const Icon(Icons.repeat_rounded),
            label: Text(item.retweetsCount == 0 ? '' : item.retweetsCount.toString()),
          ),
          TextButton.icon(
            onPressed: () {},
